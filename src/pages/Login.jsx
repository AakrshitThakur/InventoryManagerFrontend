...
export default function Login() {
  ...
  return (
    <div className="relative bg-MobileCreateEditDeleteBgImg sm:bg-DesktopCreateEditDeleteBgImg bg-cover bg-center flex-1 flex flex-col justify-center items-center p-1">
